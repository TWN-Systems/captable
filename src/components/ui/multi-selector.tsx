  ...
  (
    ...
    React.useImperativeHandle(
      ...
      () => ({
        ...
        // biome-ignore lint/style/noNonNullAssertion: inputRef is always set when component is mounted
        ...
        if (input) {
          if (e.key === "Delete" || e.key === "Backspace") {
            if (input.value === "" && selected.length > 0) {
              // biome-ignore lint/style/noNonNullAssertion: last element always exists when length > 0
